Here comes the source code for MP1. The following files are attached:
...
-- main.c : This file calls the "ackerman_main" function to exercise your allocator. You will need to add initialization and clean-up of the allocator on exit.
